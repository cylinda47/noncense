...
export function requestDiamond(id) {
    ...
    if (typeof web3 !== 'undefined') {
        ...
        return function (dispatch) {
            // Using truffle-contract we create the authentication object.
            const diamond = contract(DiamondsContract);
            diamond.setProvider(web3.currentProvider);

            diamond.web3.eth.defaultAccount = diamond.web3.eth.coinbase;
            const account = diamond.web3.eth.defaultAccount;
            ...
            // web3.eth.getCoinbase((error, coinbase) => {
                ...
                diamond.deployed().then(function (instance) {
                    ...
                    return diamondInstance.getDiamond.call(id, {from: account}).then(function(result){
